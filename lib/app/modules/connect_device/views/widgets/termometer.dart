    ...
    return Column(
      ...
      children: [
        ...
        const TextFormat(
          number: "1",
          text:
              "Hidupkan Bluetooth untuk menyambungkan aplikasi dengan termometer.",
        ),
        Center(
          child: SizedBox(
            width: 120,
        ...
        const TextFormat(
          number: "2",
          text:
              "Hidupkan termometer dengan menekan tombol power sampai termometer menyala.",
        ),
        Center(
          child: SizedBox(
            width: 140,
            height: 140,
            child: Image.asset("assets/images/termometer2.png",
                fit: BoxFit.contain),
          ),
        ),
        const SizedBox(
        ...
        Center(
          child: SizedBox(
            width: 250,
            height: 150,
            child: Image.asset("assets/images/termometer3.png",
                fit: BoxFit.contain),
          ),
        ),
        const TextFormat(
          number: "5",
          text:
              'Arahkan termometer di dahi atau telinga, kemudian tekan tombol power untuk mendapatkan hasilnya. ',
        ),
        const SizedBox(
          height: 40.0,
        ),
